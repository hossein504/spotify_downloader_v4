...
#+++++++++++
admins = [5406865643, 1525556102]
accepted_gr = [-1001707603062 ,-1001835218310]
#+++++++++++

bot_token ="5696025729:AAGC_vXh4_ffOXb6D1fvfqdxeAvaGOIINkU"
api_hash = "6ca779f183950e868ee416adf2728602"
api_id = 24033994
...
async def main(c:Client, m:Message):
    ...
    for i in accepted_gr:
        if m.chat.id == i: #yadet bashe avaz beshe j= -1001707603062 t= -1001835218310
